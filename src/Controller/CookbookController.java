...
public class CookbookController implements Initializable {
    ...
    public Button searchButton; public Button profileButton;    public Button recipeListButton;
    public Button logoutButton; public Button nextButton;   public Button backButton;
    public Button addRecipeButton;
    public Button mainListButton;
    ...
    public void searchButtonHandler(ActionEvent actionEvent) throws IOException {
        if(mainList.size() > 1){
            ...
            count = 0;
            searchList = CSV.SearchCookbook(input);
    ...
    public void addRecipeButtonHandler(ActionEvent actionEvent) {
    }
}
